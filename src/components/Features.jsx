    ...
    >
      <div>
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <h2 className="text-5xl sm:text-4xl md:text-6xl lg:text-6xl font-bold mb-4 sm:mb-6">
        ...
        <div className="space-y-16 sm:space-y-20 lg:space-y-32">
          {features.map((feature, i) => (
            ...
            >
              ...
              {/* Text section */}
              <div className="flex-1 w-full">
                <div className="max-w-lg mx-auto lx:mx-0 text-center lg:text-left">
                  <h3 className="text-4xl sm:text-3xl lg:text-4xl font-bold mb-4">
                    {feature.title}
                  </h3>
